 ...
 * structured format using Material Design components. It includes task information like title,
 * notes, dates, priority, and status, as well as a button to navigate back to the task list.
 *
